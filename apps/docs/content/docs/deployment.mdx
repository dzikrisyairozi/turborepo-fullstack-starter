...
Vercel has first-class Turborepo support. It will automatically detect your monorepo structure and only rebuild when relevant files change.
...
docker build -t turborepo-api -f Dockerfile .
