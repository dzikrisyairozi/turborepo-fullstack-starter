---
title: Introduction
description: Overview of the Monorepo Full-Stack Starter — what it is and why it exists.
---
...
| **@repo/i18n** | Full internationalization configuration and shared UI (Language Switcher) |
...
- 🌍 **Internationalization (i18n)** — Native multi-language setup (English & Indonesian)
